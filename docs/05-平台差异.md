...
## 1. General Linux Servers (Recommended Baseline) / 通用 Linux 服务器（推荐基准）
...
- After installing Docker Engine + the compose plugin, just follow [01-快速开始](01-快速开始.md).
  安装 Docker Engine + compose 插件后，按 [01-快速开始](01-快速开始.md) 操作即可
...
## 4. QNAP QTS / QuTS hero / 威联通 QTS / QuTS hero
...
## 6. Lightweight Environments Without Docker (K3s / Podman, etc.) / 无 Docker 的轻量环境（K3s / Podman 等）
